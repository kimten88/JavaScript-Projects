...
const Calculator = {
    ...
    Display_Value: "0",
    //This will cold the first operand for any expression, we set it to null for now
    First_Operand: null,
...
function Handle_Operator(Next_Operator) {
    ...
    //displayec on the screen to a number and then store the result in
    //Calculator.First_Operand if it doesn't alreadt exist
