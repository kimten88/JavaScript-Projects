...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "X") {
            ...
            //Active player may only be "X" or "O" so, if not "X" it mujst be "O"
        } else { 
...
//drawWinLine function in called to draw line if condition is met
function checkWinConditions() {
    ...
    // This conidtion checks for tie. If none of the above conditions register and 9
    //squares are selected the code executes
    else if (selectedSquares.length >= 9) {
        //This function plays the tie game sound
        audio('./media/tie.mp3');
        //This function sets a .3 seond timer before the resetGame is called
...
//This function makes our mody element temporarily unclickable
...
function resetGame() {
    //This is for loop which iterates through each HTML square element
    for (let i = 0; i < 9; i++) {
